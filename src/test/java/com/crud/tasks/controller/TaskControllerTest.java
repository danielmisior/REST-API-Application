...
class TaskControllerTest {
    ...
    @BeforeEach
    void before() {
        tasks = List.of(new Task(1L, "Task Test", "Content Test"));
        taskDtoList = List.of(new TaskDto(1L, "Task Test", "Content Test"));
        task = new Task(1L, "Task Test", "Content Test");
        taskDto = new TaskDto(1L, "Task Test", "Content Test");
        updatedTask = new Task(2L, "Updated Task", "Updated Content");
        updatedTaskDto = new TaskDto(2L, "Updated Task", "Updated Content");
    }
    ...
    void shouldGetTasks() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].title", Matchers.is("Task Test")))
    ...
    @Test
    void shouldUpgradeTask() throws Exception {
        //Given
